...
public class Project3 { //opens class Project3
   ...
   public static void main(String[] args) { //opens method main
      ...
      System.out.println("Enter 1 to see the lyrics for 99 bottles of beer on the wall \n"); //prompts the user for input
      ...
      switch (num) {//perform different actions based on value of the 'num' variable
         ...
         case 2://starts case 2 from menu
            ...
            for(int i=10; i>0; i--){ //opens for loop
               if (i == 1)
               {//opens if statement
                  System.out.print(i+ " little monkeys jumping on the bed, one fell off and bumped his head, Momma called the doctor and the doctor said, Put those monkeys straight to bed!" ); 
               }//closes if statement
               else
                  System.out.println(i+ " little monkeys jumping on the bed, one fell off and bumped his head, Momma called the doctor and the doctor said, No more monkeys jumping on the bed!" );
            }//closes for loop
            break;//closes case 2 from menu
         default://option if any other number is entered at the menu
            System.out.println("Program exited"); 
            break; //closes default case from menu 
            
      } //closes switch 
     
   } //closes method main
   
} //closes class Project3
